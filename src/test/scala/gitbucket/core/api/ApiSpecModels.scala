...
object ApiSpecModels {
  ...
  val apiRefHeadsMaster = ApiRef(
    ...
    `object` = ApiRefCommit(
      ...
      `type` = "commit",
      url =
        "https://api.github.com/repos/gitbucket/gitbucket/git/commits/6b2d124d092402f2c2b7131caada05ead9e7de6d"
    )
  )
  ...
  val apiRefTag = ApiRef(
    ...
    `object` = ApiRefCommit(
      ...
      `type` = "tag",
      url =
        "https://api.github.com/repos/gitbucket/gitbucket/git/tags/1f164ecf2f59190afc8d7204a221c739e707df4c"
    )
  )
